<div id="sidebar-container" class="collapse show bg-primary">
    <div class="logo-leftbar">
        <img src="/img/logoidtalento.png" alt="">
    </div>
    <div class="sidebar-menu">
    
        <a href=" {{route('dashboard')}} " class="{{ setActive('dashboard') }} d-block p-3 text-light font-weight-bold"> <i class="fas fa-border-all mr-2 fa-lg"></i> Escritorio</a>
        <a href="#" class="{{ setActive('notification') }} d-block p-3 text-light font-weight-bold"> <i class="fas fa-bell mr-2 fa-lg"></i> Notificacion</a>
        ...
        <div id="submenu" class="collapse child-nav">
            <ul>
                <li><a class="{{ setActive('datosPersonales') }} d-block p-3 text-light" href="#">{{ __('Datos Personales') }} </a></li>
